...
const iframeSrc = computed(() => `https://player.twitch.tv/?channel=${props.creator}&parent=${window.location.hostname}`);

</script>

<template>
  <div :id="twitchEmbedID" class="twitch-embed">
    <iframe :src="iframeSrc" frameborder="0" allowfullscreen="true" scrolling="no"></iframe>
  </div>
</template>
